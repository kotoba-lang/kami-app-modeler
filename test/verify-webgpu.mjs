...
if (!(largeScene.backend === "webgpu" && largeScene.instances === 20000 && largeScene.capacity >= 20000 && largeScene.geometryKinds === 1 && largeScene.drawCalls === 1 && largeScene.residentTriangles >= 10000000 && largeScene.firstMs < 3000 && largeScene.sampleFrames === 120 && largeScene.p95SubmitMs < 33.34 && largeScene.maxSubmitMs < 100 && largeScene.instanceBufferBytes < 10000000 && JSON.stringify(largeScene.pickingIds) === JSON.stringify([1, 10000, 20000]) && largeScene.provenanceRevision === "modeler-large-scene-v1")) throw new Error(`20,000-instance / 10M-triangle WebGPU performance gate failed: ${JSON.stringify(largeScene)}`);
